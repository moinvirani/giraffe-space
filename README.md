...
2. **Auth** → Name, email, password signup (email confirmation required)
   - After signup: "Check Your Email" screen with confirmation instructions
   - After email verified: Sign in with credentials
